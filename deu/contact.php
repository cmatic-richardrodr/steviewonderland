    		...
    		<div class="container">
      			...
      			<div class="row justify-content-center mb-5 pb-3">
         			...
         			<div class="col-md-12 heading-section text-center ftco-animate">
	          			...
	          			<span class="subheading">Stevie Wonder Land<br>Boutique Inn</span>
        	   			<h2 class="mb-4">Kontakt- und Buchungen:</h2>
         			...
         			<div class="col-md-12 heading-section text-center ftco-animate">
            				...
            				<form action="sended.php?idioma=<?php echo $idioma; ?>" class="bg-white p-5 contact-form" method="post">
              					<div class="form-group">
                					<input id="names" name="names" type="text" class="form-control" placeholder="Name">
              					</div>
              					<div class="form-group">
                					<input id="email" name="email" type="email" class="form-control" placeholder="E-Mail">
              					</div>
              					<div class="form-group">
                					<input id="telefonos" name="telefonos" type="text" class="form-control" placeholder="Telefone">
             					</div>
              					<div class="form-group">
                					<input id="asunto" name="asunto" type="text" class="form-control" placeholder="Affäre">
              					</div>
              					<div class="form-group">
                					<textarea id="mensaje" name="mensaje" textarea cols="30" rows="7" class="form-control" placeholder="Nachricht"></textarea>
              					</div>
              					<div class="form-group">
							<?php include '../captcha.php'; ?>
							<img id="aceptar_off" src='../images/boton_send_deu.png' title='Stellen Sie sicher, dass Sie ein Mensch sind, um die Nachricht zu senden'>
                					<input id="boton_s" name="boton_s" type="submit" value="Nachricht senden" class="btn btn-primary py-3 px-5" hidden />
              					</div>
            				</form>
      			...
      			<div class="row justify-content-center mb-5 pb-3">
         			...
         			<div class="col-md-12 heading-section text-center ftco-animate">
	          			...
	          			<span class="subheading">Stevie Wonder Land<br>Boutique Inn</span>
        	   			<h2 class="mb-4">Wie kommt man dahin?</h2>
