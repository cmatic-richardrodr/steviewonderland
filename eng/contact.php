      			...
      			<div class="row justify-content-center mb-5 pb-3">
         			...
         			<div class="col-md-12 heading-section text-center ftco-animate">
	          			...
	          			<span class="subheading">Stevie Wonder Land<br>Boutique Inn</span>
        	   			<h2 class="mb-4">Contact and Reservations Form:</h2>
         			...
         			<div class="col-md-12 heading-section text-center ftco-animate">
            				...
            				<form action="sended.php?idioma=<?php echo $idioma; ?>" class="bg-white p-5 contact-form" method="post">
              					...
              					<div class="form-group">
                					<input id="telefonos" name="telefonos" type="text" class="form-control" placeholder="Phones">
              					</div>
              					<div class="form-group">
                					<input id="asunto" name="asunto" type="text" class="form-control" placeholder="Reason">
              					</div>
              					<div class="form-group">
                					<textarea id="mensaje" name="mensaje" textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
              					</div>
              					<div class="form-group">
							<?php include '../captcha.php'; ?>
							<img id="aceptar_off" src='../images/boton_send_eng.png' title='Verify that you are human to send the message'>
                					<input id="boton_s" name="boton_s" type="submit" value="Send message" class="btn btn-primary py-3 px-5" hidden />
              					</div>
         			...
         			<div class="col-md-12 heading-section text-center ftco-animate">
	          			...
	          			<span class="subheading">Stevie Wonder Land<br>Boutique Inn</span>
        	   			<h2 class="mb-4">How to get there?</h2>
