...
if ($room == '') {
    		...
    		<div class="container">
      			...
      			<div class="row justify-content-center mb-5 pb-3">
          			...
          			<div class="col-md-12 heading-section text-center ftco-animate">
          				...
          				<span class="subheading">StevieWonderLand<br>Boutique Inn</span>
            				<h2 class="mb-4">Our Rooms:</h2>
					<font size=4>
					We have nine (9) beautiful rooms and suites, each one in a different style where you will feel VIP... especially enjoying our delicious breakfasts.
					</font>
	...
	switch ($room) {
		...
		case 'amor';
			$room_nombre = "Matrimonial Room " . strtoupper($room);
			break;
		case 'arte':
			$room_nombre = "Matrimonial Room " . strtoupper($room);
			break;
		case 'bavaria':
			...
			break;
		case 'blue':
			$room_nombre = "Deluxe Room " . strtoupper($room);
			break;
		case 'camarote':
			$room_nombre = "Double Matrimonial Room " . strtoupper($room);
			break;
		case 'caribe':
			$room_nombre = "Superior Suite " . strtoupper($room);
			break;
		case 'espana':
			$room_nombre = "Matrimonial Suite ESPAÑA";
			break;
		case 'memoria':
			$room_nombre = "Matrimonial Room " . strtoupper($room);
			break;
    	...
    	<section class="ftco-section bg-light ftco-room">
    		...
    		<div class="container">
      			...
      			<div class="row justify-content-center mb-5 pb-3">
					...
					<button onclick='AbrirContactos();'>Booking</button><br><br>
					...
					<br><br><button onclick='AbrirContactos();'>Booking</button>
